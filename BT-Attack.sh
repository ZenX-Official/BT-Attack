...
# Coded: Zenzed | ZenX | ZxOfficial
# Site: https://mywebsite1999.000webhostapp.com/
# i <3 open source;
...
function about_me () {
  banner
  echo ""
  echo " CODE NAME: ZenZed | ZenX | ZX Official"
  echo " Site: https://mywebsite1999.000webhostapp.com"
  echo " Facebook Page: https://www.facebook.com/ZenZed_Official-100339685097116"
  echo " # BT-CONNECTION-DUMPING
...
function main() {
    ...
    banner
    echo ""
    echo -e " \e[37m[01] Attack BT devices                       [03] About"
